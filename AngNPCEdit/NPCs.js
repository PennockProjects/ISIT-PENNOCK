...
function TableEditor($scope, $dialog) {
  ...
  $scope.NPCs = [
    {name: 'Lucy', 		hitPoints: 25,	health: 32, totalMoves: 0},
    {name: 'Saulti', 	hitPoints: 10,	health: 11, totalMoves: 12},
    {name: 'Cannius', 	hitPoints: 11, 	health: 12, totalMoves: 13},
    {name: "Grog", 		hitPoints: 12,	health: 13, totalMoves: 14}
  ];
